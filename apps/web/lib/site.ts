 ...
 * accelerator's own Amplience Frontend Starter defaults; see .env.example for the knobs.
 */

export const siteTitle = process.env.SITE_TITLE ?? 'Amplience Frontend Starter'
 ...
 * only the base is configurable. Default is the bundled Amplience set in
...
/** Browser-chrome theme colour (manifest + meta). Amplience brand purple. */
