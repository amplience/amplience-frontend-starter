/**
 * LocaleSelectorConfigured — the deployment's locale-selector (ADR-0015).
 *
 * The library's `LocaleSelector` is config-free: it takes the locale list as
 ...
 * `LOCALE_SELECTOR_SCHEMA` component in `apps/web/lib/registry.ts`, the same
