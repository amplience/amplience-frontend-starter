...
Amplience Frontend Starter is a demo-ready frontend that brings Amplience content to life — publish and go!

## Why it exists

A headless CMS is powerful, but there's an inherent challenge: **how do you demonstrate a headless system without a head?** Content lives in Amplience CMS, beautifully structured and ready to deliver — but clients, stakeholders, and content teams need to _see_ how that content becomes a digital experience before investing in a custom frontend.

A ready-made head is the answer: a composable, flexible Next.js frontend that renders any content you create in Amplience, works out of the box, and adapts to your brand through content-controlled styling.
...
Amplience Frontend Starter is the open-source distillation of those ideas: the same recursive, content-driven rendering engine, rebuilt lean.

## What exactly is Amplience Frontend Starter?

It's a composable, flexible Next.js frontend designed to demonstrate the full power of Amplience — the "head" for your headless CMS. It renders any content you create in Amplience, works out of the box with minimal configuration, and adapts to your brand through design tokens.
